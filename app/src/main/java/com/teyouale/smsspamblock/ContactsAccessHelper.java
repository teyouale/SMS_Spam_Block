...
import com.teyouale.smsspamblock.utils.DatabaseAccessHelper.ContactSource;
...
//-------------------------------------------------------------------------------------
    ...
    public Cursor getContacts(Context context, ContactSourceType sourceType, @Nullable String filter) {
        ...
        if (permission == null || !Permissions.isPermissionGranted(context, permission)) {
            return null;
        }
        // return contacts
        switch (sourceType) {
...
//-------------------------------------------------------------------------------------
    ...
    public Contact getContact(Context context, String number) {
        if (!Permissions.isPermissionGranted(context, Permissions.READ_CONTACTS)) {
            return null;
        }
    ...
    public boolean containsNumberInSMSContent(Context context, @NonNull String number) {
        if (!Permissions.isPermissionGranted(context, Permissions.READ_SMS)) {
            return false;
        }
    ...
    public boolean deleteLastRecordFromCallLog(Context context, String number, long duration) {
        if (!Permissions.isPermissionGranted(context, Permissions.WRITE_CALL_LOG)) {
            return false;
        }
    ...
    private long getLastRecordIdFromCallLog(Context context, String number, long duration) {
        if (!Permissions.isPermissionGranted(context, Permissions.READ_CALL_LOG)) {
            return -1;
        }
    ...
    public SMSConversationWrapper getSMSConversations(Context context) {
        if (!Permissions.isPermissionGranted(context, Permissions.READ_SMS) ||
                !Permissions.isPermissionGranted(context, Permissions.READ_CONTACTS)) {
            return null;
        }
...
//--------------------------------------------------------------------------------
    ...
    public boolean setSMSMessagesReadByThreadId(Context context, int threadId) {
        if (!Permissions.isPermissionGranted(context, Permissions.WRITE_SMS)) {
            return false;
        }
